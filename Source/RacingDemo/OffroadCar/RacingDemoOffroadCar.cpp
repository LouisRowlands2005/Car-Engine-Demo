...
#include "RacingDemoOffroadCar.h"
#include "RacingDemoOffroadWheelFront.h"
#include "RacingDemoOffroadWheelRear.h"
...
ARacingDemoOffroadCar::ARacingDemoOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URacingDemoOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URacingDemoOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URacingDemoOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URacingDemoOffroadWheelRear::StaticClass();
