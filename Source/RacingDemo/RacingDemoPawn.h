...
#include "RacingDemoPawn.generated.h"
 ...
 */
UCLASS(abstract)
class ARacingDemoPawn : public AWheeledVehiclePawn
{
	GENERATED_BODY()
...
protected:
	...
	// Used to link damage to speed and acceleration for the sports car
	virtual float DamageScalar() { return 1.0f; } //---My code---
