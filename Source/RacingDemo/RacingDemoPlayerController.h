...
#include "RacingDemoPlayerController.generated.h"

class UInputMappingContext;
class ARacingDemoPawn;
class URacingDemoUI;
 ...
 */
UCLASS(abstract)
class ARacingDemoPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ARacingDemoPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ARacingDemoPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<URacingDemoUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<URacingDemoUI> VehicleUI;
